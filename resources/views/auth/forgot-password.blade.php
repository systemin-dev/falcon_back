                ...
                <div class="w-lg-500px p-10">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::Email-->
                            <input type="email" placeholder="Email" name="email" autocomplete="off" value="{{ old('email') }}" id="email" required class="form-control bg-transparent" />
                            <!--end::Email-->
                            @if ($errors->has('email'))
                        ...
                        <div class="d-grid mb-10">
                            <button type="submit" id="kt_password_reset_submit" class="btn btn-primary">
                                ...
                                <span class="indicator-label">Envoyer le lien de réinitialisation</span>
                                <!--end::Indicator label-->
